...
public class Employee {
   ...
   //condition you have to give
    ...
    public Employee(String name, int age, String jobTitle, double salary) {
        ...
        setSalary(salary);
        // before we assign them it ned s to check the conditions so we put seters here
    ...
    public String getName() {
        if(name == null){
            return "unKnown";// it better to get unknow than null pointer exception
        }
        return name;
    }
