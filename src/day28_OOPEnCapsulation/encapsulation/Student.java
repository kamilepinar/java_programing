...
public class Student {
  ...
  public int getAge() { //read only
    ...
    public void setAge(int age){//set the data.write only
    if(age < 1 || age > 100){
      System.err.println("invalid age: "+age);
      //return;//exitting the method ama hala 0 verir tamamamen cikmak icin
      System.exit(1);//program gets terminated
    }
    this.age =age ;//bunu koyarsan set yapabiiyorsun diger classda
