...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        Employee[] employees = { // burda Developer yada Tester referenca yapamazdim  hepsini cagiramazdin yoksa, object yapsaydin kabul ederdi ama methodlari cagiramazdi
