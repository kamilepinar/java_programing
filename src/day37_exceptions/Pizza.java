...
if(size == ( ( pizza)obj ).size){
 if(numberOfPepporoniTopping == ( (pizza)obj ).getNumberOfPepperoniTopping()){
 return true;}
 return false} burda surekl;i surekli downcasting yapmis tekrar olmasin diye bir kere pizza obj create yapip down casting yaparsan daha okunur oldu*/