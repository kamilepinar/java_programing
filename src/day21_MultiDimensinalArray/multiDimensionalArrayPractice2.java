...
public class multiDimensionalArrayPractice2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.deepToString(arr3D));//bu tumunu veriyor

        System.out.println( Arrays.deepToString( arr3D[1] ) ); // [[6, 7, 8, 9], [10, 11], [12, 13, 14]] birinci indexi

        System.out.println( Arrays.toString( arr3D[0][1] ) ); // [3, 4, 5] o inci indexin birinci indexini veriyor

        System.out.println( Arrays.toString( arr3D[1][0]  )); // [6, 7, 8, 9]//burda tek dimenional array sordugu icin tostring yeter
