...
public class MethodOverloadingPractice {
    ...
    public static double sum(double num1, double num2){// iki data verdigi oldu ama onlar int di bu double
        return num1 + num2;// ya numarasi ya data type farkli olmali
    }
