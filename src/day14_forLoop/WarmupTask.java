...
public class WarmupTask {
    public static void main(String[] args) {
        ...
        String strResult=combine("one","eight");
    ...
    public static String combine(String str1, String str2) {
        ...
        // bu endswith sadece string ile calistigindan char at methodu kullanmiyosun bunun icin charat methodunun yanina tirnak icareti arti koyuyoruz

        if (str1.endsWith("" + str2.charAt(0))) {//if the first string ends with the first character of second
