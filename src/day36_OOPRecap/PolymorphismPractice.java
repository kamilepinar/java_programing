...
public class PolymorphismPractice {
    ...
    public static void main(String[] args) {
        ...
        //   IPhone phone = new Phone("Iphone 11 Pro", "Large", "Black", 900);//bu ters
        // parent Phone reference olmasi gerek poly de

        //Phone phone =  new Samsung("Galaxy S19", "Medium", "Pink", 700);//bu Phone phone reference type ile ister IPhone ister samsung ister nokia koy
       // day 30 uc classPhone ile is a relation ship te
