...
public abstract class Car {
    ...
    } // bu hepsinde ayni degismez o yuzden final, ve kendi subclasi disinda cagirma diye protected

    protected abstract void start(); // meant to be overridden// default olsa diger clsslar alamaz
    //sadece public and protected acces yapabildigi icin

    @Override
    public String toString() {
        return make +"{" + //burayida degisti make = make yapmadi direk tek seferde versin diye boyle yapti
                "model='" + model + '\'' +
                ", color='" + color + '\'' +
                ", year=" + year +
                ", price= $" + price +
