...
public class MapClasses {
    public static void main(String[] args) {
        ...
        Map<String, Integer> linkedHashMap = new LinkedHashMap<>(); // insertion order, accepts null key  & null values but not both
        ...
        linkedHashMap.put(null, 100000);//not both null
