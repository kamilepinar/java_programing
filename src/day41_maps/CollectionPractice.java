...
public class CollectionPractice {
    public static void main(String[] args) {
        ...
        //10
        System.out.println(lists.get(1).get(3));//ikinci listenin ucuncu indexi aliyoruz demek bu
        ...
        listOfSets.add(new LinkedHashSet<>());  // 0//hashset olsaydi order olmazdi ondan linked hasset kullandi if order matter
        listOfSets.add(new LinkedHashSet<>());  // 1
        listOfSets.add(new LinkedHashSet<>());  // 2
        listOfSets.add(new LinkedHashSet<>());  // 3//bunlar  ici bos element print yapiyo

        System.out.println(listOfSets);

        // {10, 5, 20}

        listOfSets.get(0).addAll(Arrays.asList(10, 5, 20, 10, 5, 20));//if you want to retrive any set you need to get method it
        ...
        //this part is arr/[2] this is the arrays element
       ...
       // List<List<Integer>> list = new ArrayList<>(); //list of list (don't call multidemensinal list
       // List <Arrays[]> list3 = this is list of array
