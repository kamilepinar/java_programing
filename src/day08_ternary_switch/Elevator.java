 ...
 */
        ...
        int floorNumber = 10;//assign empty string"" as temporary if you dont have value


        String  result = "Invalid floor";//eger 1-2 yada 3 degilse direk invalid vericek

        if(floorNumber >= 1 && floorNumber <= 3){

            result = "Floor "+floorNumber+" is selected. Companies: ";
            //uzun uzun print statement yazicagimiza kisa result kodu yaziyoruz sonra += concantenation ile
            //stringe compay isimlerini ekliyorum
...
// bu alttaki eski uzun hali
        /*if(floorNumber >=1 && floorNumber <= 3) if (floorNumber == 1) {
