...
import day28_OOPEnCapsulation.personTask.Person;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AccessModifiers.protectedData);//within same pak accesseble same class accesable

        System.out.println(AccessModifiers.defaultData);//under same pkg accesable but different pkg not acces.
