...
public class ConstructorsIntro {
    public ConstructorsIntro(){//we create this constructer not by defaul so we will be able to grup code fragment for certain task
...
//      add is method name
//stattic is specifier is optional if you dont give it will be instant method
// but return type is must , burda void