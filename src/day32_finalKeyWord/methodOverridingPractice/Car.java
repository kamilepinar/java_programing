...
public static boolean hasBattery;
    ...
    public Car(String model, String color, int year, double price) {
       setMake(getClass().getSimpleName());//set the class name to the make of the car
       setModel(model);
       setColor(color);
       setYear(year);
       setPrice(price);
       //  numberOfWheels =4;
      /// hasBattery =true; burda yaparsan 10  kez create yaparsan  10 kez cikar oyuzden instance block
