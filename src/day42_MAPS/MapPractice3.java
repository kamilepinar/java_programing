...
public class MapPractice3 {
    public static void main(String[] args) {
        ...
        // arrayOfMap[5] = new LinkedHashMap<>();array size fixed index out of bound exception

        arrayOfMap[1].replace("salary", ( (Integer)arrayOfMap[1].get("salary") ) + 10000);
        arrayOfMap[0].replace("name", "Hasan");

        System.out.println(Arrays.toString(arrayOfMap));//every single map in this array

        System.out.println("------------------------------------------------");
        int count = 0;//how many employee make less than 100k  we can increase the count everytime we check the
