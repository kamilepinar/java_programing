...
public class MapPractice1 {
    public static void main(String[] args) {
        ...
        /*
        for (String name : employeeMap.keySet()) { //we are getting each key
        ...
        */
        ...
        /*
        for (String name(each key) : employeeMap.keySet()) {
            String gender =employeeMap.get(name);//anlamadim
            if(gender.equals("F")){
        ...
        for (Map.Entry<String, String> eachEntry : employeeMap.entrySet()) {
            if(eachEntry.getValue().equals("M")){//get ile key aldik value verdi eger value m ise male yazsin diye update yapti
                eachEntry.setValue("Male");//we are updating the values
            }else{
